...
const BreakingBad = (props) => {
    ...
    useEffect(() => {
        if (isMobile) {
            [hermanoModel, skyPanoModel, walterModel, jesseModel, fleetwoodModel].forEach(model => {
    ...
    }, [hermanoModel, skyPanoModel, walterModel, jesseModel, fleetwoodModel]);

    return (
        <group ref={ref} scale={isMobile ? 0.8 : 1} {...props}>
            <primitive
                object={skyPanoModel.scene}
                scale={isMobile ? 4 : 5}
                position={[0, 5, -5]}
