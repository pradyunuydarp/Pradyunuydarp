    ...
    return (
        <>
            ...
            <div className="absolute left-10  transform -translate-y-1/2 z-10 max-w-md">
                <div className="bg-[#1A1A1A] bg-opacity-95 border-2 border-[#4FB1BC] rounded-xl shadow-2xl p-6">
                    <h2 className="text-4xl font-bold mb-4 text-[#F0C02F]">Cinematic Universes</h2>
                    <p className="text-lg leading-relaxed text-[#EAEAEA] font-medium">
                        Dive deeper into iconic stories that have shaped our culture.
                        <br/>
                        This scene pays homage to <span
                        className="text-[#7ADFE1] font-semibold">Breaking Bad</span> —
